...
##
##     docker build --build-arg TYPE=api --build-arg VHOST=machine-learning-api.com --build-arg HOST_PORT=9090 --build-arg LISTEN_PORT=6000 --build-arg MEMBERS='localhost:6001' -f nginx.dockerfile -t jeff1evesque/ml-nginx-api:0.7 .
##     docker build --build-arg TYPE=web --build-arg VHOST=machine-learning.com --build-arg HOST_PORT=8080 --build-arg LISTEN_PORT=5000 --build-arg MEMBERS='localhost:5001' -f nginx.dockerfile -t jeff1evesque/ml-nginx-web:0.7 .
##

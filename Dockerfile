...
RUN for x in /var/machine-learning/puppet/environment/development/manifests/*.pp; do /opt/puppetlabs/bin/puppet apply "$x" --modulepath=/var/machine-learning/puppet/environment/development/modules_contrib:/var/machine-learning/puppet/environment/development/modules confdir=/var; done;

...
## debug print
RUN print puppet config print modulepath
RUN print puppet config print modulepath --section master
RUN print puppet config print modulepath --section master --environment development

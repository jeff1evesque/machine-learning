      ...
      # convert each dataset as json, validate, and store in database
        ...
        for val in json_file_upload['file_upload']:
          ...
          if val['type'] in ('text/plain', 'text/csv'):
            try:
              json_dataset = json.loads( {'id_entity': id_entity, 'svm_dataset': JSON( val['data']['dataset']['file_upload']['file_temp']).csv_to_json() )
          ...
          # xml to json
            ...
            try:
              json_dataset = json.loads( {'id_entity': id_entity, 'svm_dataset': JSON( val['data']['dataset']['file_upload']['file_temp']).xml_to_json() )

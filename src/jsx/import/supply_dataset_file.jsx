        ...
        return(
            <fieldset className='fieldset-supply-dataset'>
                ...
                {inputs && inputs.map(function(value, index){
                    return <input type='file' name='svm_dataset[]' className='svm-dataset-file more-choose' key={index} onChange={this.validUrlEntered} value={this.state['value_dataset_' + index.toString()]} />;
                }.bind(this))}

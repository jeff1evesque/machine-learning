...
def bagging(
    ...
    classifiers = [list_model_type[3], list_model_type[5], list_model_type[7], list_model_type[9]]
    regressors = [list_model_type[4], list_model_type[6], list_model_type[8], list_model_type[10]]

...
**Note:** different executions of this program may involve different *dependent*, and *independent* variables. Therefore, the database schema is not known ahead of time. For this reason, the EAV data model is implement for storing SVM datasets.

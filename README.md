...
**Note:** in addition to unit-testing, every script, or file(s) within this repository is linted via [`.travis.yml`](https://github.com/jeff1evesque/machine-learning/blob/master/.travis.yml).
